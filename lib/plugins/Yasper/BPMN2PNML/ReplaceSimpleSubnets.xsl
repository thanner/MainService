                        ...
                        <xsl:element name="arc">
                            ...
                            <xsl:if test="../referencePlace[ @id = $id ]/toolspecific/tool:pathGraphics">
                                <xsl:element name="graphics">
                                    <xsl:for-each
                                            select="../referencePlace[ @id = $id ]/toolspecific/tool:pathGraphics/tool:position">
                ...
                <xsl:element name="transition">
                    ...
                    <xsl:element name="graphics">
                        ...
                        <xsl:element name="dimension">
                            <xsl:attribute name="x">
                                <xsl:value-of select="graphics/dimension/@x"/>
                            </xsl:attribute>
                            <xsl:attribute name="y">
                                <xsl:value-of select="graphics/dimension/@y"/>
                            </xsl:attribute>
                        </xsl:element>
                    </xsl:element>
