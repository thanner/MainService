...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="Gateways" name="Gateways">
        <xsl:for-each select="Gateways/Gateway">
            ...
            <xsl:variable name="px">
                <xsl:value-of select="MiddlePoint/@X"/>
            </xsl:variable>
            <xsl:variable name="py">
                <xsl:value-of select="MiddlePoint/@Y"/>
            </xsl:variable>
            ...
            <xsl:variable name="weights">
                <xsl:for-each select="StatisticalData/OutputWeight">
                    <xsl:value-of select="translate(translate(@OutputElementId,'(',''),')','')"/>,<xsl:value-of
                        select="Weight"/><xsl:text> </xsl:text>
                </xsl:for-each>
            </xsl:variable>
            <!-- /Statistical Data -->
            ...
            <xsl:for-each select="../../SequenceFlows/SequenceFlow[ translate(translate(Target,'(',''),')','') = $id]">
                ...
                <xsl:call-template name="PlaceFrameWork">
                    <xsl:with-param name="id">pl<xsl:value-of select="$id"/>_<xsl:value-of select="$count"/>
                    </xsl:with-param>
                ...
                <xsl:call-template name="ArcFrameWork">
                    <xsl:with-param name="id">ar<xsl:value-of select="$id"/>_<xsl:value-of select="$count"/>
                    </xsl:with-param>
                    <xsl:with-param name="source">pl<xsl:value-of select="$id"/>_<xsl:value-of select="$count"/>
                    </xsl:with-param>
                    <xsl:with-param name="target">tr<xsl:value-of select="$id"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:for-each>
            ...
            <xsl:for-each select="../../SequenceFlows/SequenceFlow[ translate(translate(Source,'(',''),')','') = $id]">
                ...
                <xsl:call-template name="ArcFrameWork">
                    ...
                    <xsl:with-param name="source">tr<xsl:value-of select="$id"/>
                    </xsl:with-param>
    ...
    <xsl:template match="Tasks" name="Tasks">
        <xsl:for-each select="Tasks/Task">
            ...
            <xsl:variable name="id">
                <xsl:value-of select="translate(translate(@id,'(',''),')','')"/>
            </xsl:variable>
            ...
            <xsl:choose>
                <xsl:when test="Description = 'LoopMarker' ">
                    ...
                    <xsl:if test="count(../../SequenceFlows/SequenceFlow[ translate(translate(Target,'(',''),')','') = $id]) > 0">
                        <xsl:for-each select="../../SequenceFlows/SequenceFlow[ Target = $realID]">
                            <xsl:if test="position() = 1">
                                <xsl:variable name="SourceID" select="Source"/>
                                <xsl:call-template name="PlaceFrameWork">
                                    <xsl:with-param name="id">pl<xsl:value-of select="$id"/>
                                    </xsl:with-param>
                                    <xsl:with-param name="px">
                                        <xsl:call-template name="GetPositionX">
                                            <xsl:with-param name="X" select="$px"/>
                    ...
                    <xsl:element name="page">
                        <xsl:attribute name="id">pa<xsl:value-of select="translate(translate($realID,'(',''),')','')"/>
                        </xsl:attribute>
                        ...
                        <xsl:if test="count(../../SequenceFlows/SequenceFlow[ translate(translate(Target,'(',''),')','') = $id]) > 0">
                            <xsl:call-template name="ReferencePlaceFrameWork">
                                <xsl:with-param name="id">ref<xsl:value-of select="$id"/>
                                </xsl:with-param>
                                <xsl:with-param name="ref">pl<xsl:value-of select="$id"/>
                                </xsl:with-param>
                                <xsl:with-param name="px" select="50"/>
                                <xsl:with-param name="py" select="100"/>
                            </xsl:call-template>
                            <xsl:call-template name="ArcFrameWork">
                                <xsl:with-param name="id">arc1<xsl:value-of select="$id"/>
                                </xsl:with-param>
                                <xsl:with-param name="source">ref<xsl:value-of select="$id"/>
                                </xsl:with-param>
                                <xsl:with-param name="target">trtrSTART<xsl:value-of select="$id"/>
                                </xsl:with-param>
                            </xsl:call-template>
                        </xsl:if>

                        <xsl:call-template name="TransitionFrameWork">
                            <xsl:with-param name="id">trSTART<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        ...
                        <xsl:call-template name="PlaceFrameWork">
                            <xsl:with-param name="id">pl1<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        ...
                        <xsl:call-template name="ArcFrameWork">
                            <xsl:with-param name="id">arc2<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="source">trtrSTART<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="target">pl1<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        </xsl:call-template>

                        <!-- The actual subnet, with extra level params-->
                        <xsl:call-template name="SubnetFrameWork">
                            <xsl:with-param name="id">Loop<xsl:value-of
                                    select="translate(translate(@id,'(',''),')','')"/>
                            </xsl:with-param>
                            <xsl:with-param name="name" select="$name"/>
                            ...
                            <xsl:with-param name="ref_inID">
                                <xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="ref_outID">
                                <xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <!-- /Optional Extra Level -->
                        </xsl:call-template>
                        ...
                        <xsl:call-template name="PlaceFrameWork">
                            <xsl:with-param name="id">pl2<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        ...
                        <xsl:call-template name="TransitionFrameWork">
                            <xsl:with-param name="id">tr3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        ...
                        <!-- PL2 to Tr3 -->
                        <xsl:call-template name="ArcFrameWork">
                            <xsl:with-param name="id">arc3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="source">pl2<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="target">trtr3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        </xsl:call-template>

                        <xsl:call-template name="PlaceFrameWork">
                            <xsl:with-param name="id">pl3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        ...
                        <!-- tr3 to PL3 -->
                        <xsl:call-template name="ArcFrameWork">
                            <xsl:with-param name="id">arc4<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="source">trtr3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="target">pl3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        </xsl:call-template>

                        <!-- Pl3 to TrEnd -->
                        <xsl:call-template name="ArcFrameWork">
                            <xsl:with-param name="id">arc5<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="source">pl3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="target">trtrEND<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        </xsl:call-template>

                        <!-- XOR to pl1 -->
                        <xsl:call-template name="ArcFrameWork">
                            <xsl:with-param name="id">arc6<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="source">trtr3<xsl:value-of select="$id"/>
                            </xsl:with-param>
                            <xsl:with-param name="target">pl1<xsl:value-of select="$id"/>
                        ...
                        <xsl:call-template name="TransitionFrameWork">
                            <xsl:with-param name="id">trEND<xsl:value-of select="$id"/>
                            </xsl:with-param>
                        ...
                        <!-- Needed for output...-->
                        <xsl:for-each
                                select="../../SequenceFlows/SequenceFlow[ translate(translate(Source,'(',''),')','') = $id ] ">
                            <xsl:variable name="Target" select="Target"/>
                            <xsl:variable name="count" select="count(preceding::SequenceFlows)"/>
                            <xsl:call-template name="ReferencePlaceFrameWork">
                                <xsl:with-param name="id">ref<xsl:value-of select="$id"/>_<xsl:value-of
                                        select="$count"/>
                                </xsl:with-param>
                                ...
                                <xsl:with-param name="py">
                                    <xsl:value-of select="50 + (50 * position() )"/>
                                </xsl:with-param>
                            </xsl:call-template>

                            <xsl:call-template name="ArcFrameWork">
                                <xsl:with-param name="id">arc<xsl:value-of select="$id"/>_<xsl:value-of
                                        select="position()"/>
                                </xsl:with-param>
                                <xsl:with-param name="source">trtrEND<xsl:value-of select="$id"/>
                                </xsl:with-param>
                                <xsl:with-param name="target">ref<xsl:value-of select="$id"/>_<xsl:value-of
                                        select="$count"/>
                                </xsl:with-param>
                            </xsl:call-template>
                        </xsl:for-each>
    ...
    <xsl:template match="SubProcesses" name="SubProcesses">
        <xsl:for-each select="SubProcesses/SubProcess">
            ...
            <xsl:variable name="EndEventID"
                          select="translate(translate(BPMNElements/EndEvents/EndEvent/@id,'(',''),')','')"/>


            <xsl:if test="count(../../SequenceFlows/SequenceFlow[ translate(translate(Target,'(',''),')','') = $id]) > 0">
                <xsl:for-each
                        select="../../SequenceFlows/SequenceFlow[ translate(translate(Target,'(',''),')','') = $id]">
                    <xsl:if test="position() = 1">
                        <xsl:variable name="SourceID" select="Source"/>
                        <xsl:call-template name="PlaceFrameWork">
                            <xsl:with-param name="id">pl<xsl:value-of select="$id"/>
            ...
            <xsl:element name="page">
                <xsl:attribute name="id">sn<xsl:value-of select="$id"/>
                </xsl:attribute>
                ...
                <xsl:for-each
                    ...
                    <xsl:call-template name="ReferencePlaceFrameWork">
                        <xsl:with-param name="id">rp_si<xsl:value-of select="$id"/>_<xsl:value-of select="position()"/>
                        </xsl:with-param>
                        <xsl:with-param name="ref">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="boolean( ../../Gateways/Gateway/@id = $Target )">
                                    <xsl:value-of select="translate(translate(Target,'(',''),')','')"/>_<xsl:value-of
                                        select="count(preceding::SequenceFlow)"/>
                                </xsl:when>
                    ...
                    <xsl:call-template name="ArcFrameWork">
                        <xsl:with-param name="id">ar_si<xsl:value-of select="$id"/>_<xsl:value-of select="position()"/>
                        </xsl:with-param>
                        <xsl:with-param name="source">trEnd_<xsl:value-of select="$EndEventID"/>
                        </xsl:with-param>
                        <xsl:with-param name="target">rp_si<xsl:value-of select="$id"/>_<xsl:value-of
                                select="position()"/>
                        </xsl:with-param>
                    </xsl:call-template>
                </xsl:for-each>
        ...
        <xsl:for-each select="StartEvents/StartEvent">
            ...
            <xsl:choose>
                <xsl:when test="string-length($SubProcessID) = 0">
                    ...
                    <xsl:element name="transition">
                        <xsl:attribute name="id">Start_<xsl:value-of select="$id"/>
                        </xsl:attribute>
                        <xsl:element name="name">
                            <xsl:element name="text">
                                <xsl:value-of select="$name"/>
                        ...
                        <xsl:element name="toolspecific">
                            ...
                            <xsl:if test="$mean > 0 or $deviation > 0">
                                <xsl:element name="processingTime"
                                             namespace="http://www.yasper.org/specs/epnml-1.1/toolspec">
            ...
            <xsl:if test="boolean(../../../../../SequenceFlows/SequenceFlow[ translate(translate( Target ,'(','' ), ')', '') = $SubProcessID ])">
                <xsl:call-template name="ReferencePlaceFrameWork">
                    ...
                    <xsl:with-param name="ref">pl<xsl:value-of select="$SubProcessID "/>
                    </xsl:with-param>
                    <xsl:with-param name="px" select="$px - 50"/>
                    <xsl:with-param name="py" select="$py"/>
                </xsl:call-template>
                <xsl:call-template name="ArcFrameWork">
                    <xsl:with-param name="id">ar<xsl:value-of select="$id"/>
                    </xsl:with-param>
                    <xsl:with-param name="source">ref<xsl:value-of select="$id"/>
                    </xsl:with-param>
                    <xsl:with-param name="target">Start_<xsl:value-of select="$id"/>
                    </xsl:with-param>
                </xsl:call-template>
            </xsl:if>
            <xsl:for-each select="../../SequenceFlows/SequenceFlow[ translate(translate(Source,'(',''),')','') = $id ]">
                <xsl:variable name="Target" select="Target"/>
                <xsl:call-template name="ArcFrameWork">
                    <xsl:with-param name="id">ar<xsl:value-of select="$id"/>_<xsl:value-of
                            select="count(preceding::SequenceFlow)"/>
                    </xsl:with-param>
                    <xsl:with-param name="source">Start_<xsl:value-of select="$id"/>
                    </xsl:with-param>
                    <xsl:with-param name="target">
                        <xsl:call-template name="GetPlace">
        ...
        <xsl:for-each select="EndEvents/EndEvent">
            ...
            <xsl:choose>
                <xsl:when test="string-length($SubProcessID) = 0">
                    <!-- Create Collector -->
                    <xsl:element name="transition">
                        <xsl:attribute name="id">trEnd_<xsl:value-of select="$id"/>
                        </xsl:attribute>
                        <xsl:element name="name">
                            <xsl:element name="text">
                                <xsl:value-of select="$name"/>
            ...
            <xsl:for-each select="../../SequenceFlows/SequenceFlow[ translate(translate(Target,'(',''),')','') = $id ]">
                ...
                <xsl:if test="position() = 1">
                    ...
                    <xsl:call-template name="ArcFrameWork">
                        ...
                        <xsl:with-param name="source">pl<xsl:value-of select="$id"/>
                        </xsl:with-param>
                        <xsl:with-param name="target">
        ...
        <xsl:for-each select="IntermediateEvents/IntermediateEvent">
            ...
            <xsl:choose>
                ...
                <xsl:when test="Trigger = 'Message' or 'Compensation' ">
                    ...
                    <xsl:call-template name="ArcFrameWork">
                        <xsl:with-param name="id">ar_ie<xsl:value-of select="$id"/>
                        </xsl:with-param>
                        <xsl:with-param name="source">pl<xsl:value-of select="$id"/>
                        </xsl:with-param>
                        <xsl:with-param name="target">tr<xsl:value-of select="$id"/>
                    ...
                    <xsl:call-template name="PlaceFrameWork">
                        <xsl:with-param name="id">pl_ie<xsl:value-of select="$id"/>
                        </xsl:with-param>
                        <xsl:with-param name="px" select="$px"/>
                    ...
                    <xsl:call-template name="ArcFrameWork">
                        <xsl:with-param name="id">ar_ie2<xsl:value-of select="$id"/>
                        </xsl:with-param>
                        <xsl:with-param name="source">tr<xsl:value-of select="$id"/>
                        </xsl:with-param>
                        <xsl:with-param name="target">pl_ie<xsl:value-of select="$id"/>
                        </xsl:with-param>
                    </xsl:call-template>
                    <xsl:for-each
                            select="../../SequenceFlows/SequenceFlow[ translate(translate(Source,'(',''),')','') = $id ] ">
